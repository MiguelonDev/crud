<?php
/*
 * Documento principal de la aplicacion que contiene la estructura b�sica html y la tabla de consulta
...
/*
 * Funci�n que se ejecuta al pulsar en un elemento de etiqueta "a"
 * y que carga en el "div" #accion el c�digo correspondiente al
 * documento recibido en el par�metro "href"
 */
    ...
    try {
        ...
        echo '<form method="post" action="controlador/insertar.php">
                ...
                <table class="tabla">
                    ...
                    <tbody>';
            // bucle que se encarga de crear la tabla de datos en funci�n de los registros encontrados
            foreach ($rows as $row) {            
                echo '
                      <tr> 
                           <td>' . $row['Nombre'] . '</td> 
            ...
            echo     ' 
                      <tr>
                          ...
                          <td><input type="text" name="tel" id="tel" placeholder="Tel�fono"></input></td>
