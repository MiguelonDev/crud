 ...
 * cargar� en el formulario los datos del registro a borrar
 * 
 * Una vez se pulse en el bot�n "Aceptar", se eliminar� ese registro de la BBDD
...
$conn = null;
    ...
    if(!isset($_POST['delete'])){
        ...
        echo '
            ...
            echo 'alert("No se ha borrado por un fallo de conexi�n a base de datos")';
        }
